                ...
                <Row gutter={24} justify='center' style={{margin:'20px 0px'}} >
                    ...
                    <Col span={6}>
                        <Card style={{backgroundColor:'#73C0DE',borderRadius:'8px'}}>
                            <Statistic title="客户数(个)" value={1893} precision={2} />
                        </Card>
                    </Col>
                </Row>
